  ...
  return (
    <div className={styles['container']}>
      <div className={styles['exhibit-introduce-section']}>
        <div className={styles['title']}>학과 소개</div>
        <div className={styles['info-section']}>
          <img src={balaPoster} alt="발아 졸업 전시회 포스터" />
          <div className={styles['info-section__info']}>
            씨앗에서부터 더 높은 단계로 나아가기 위한 출발. 발아는 단순한 생명의
            시작을 넘어, 가능성과 희망, 그리고 무한한 잠재력의 상징입니다.
            모여있던 홀씨들은 4년간 한 곳에서 함께 배우고 성장하며 이제 새로운
            곳으로 비상할 준비를 마쳤습니다.
            <br />
            <br /> 더 멀리 낯선 곳에서 꽃 피우기 위한 우리의 도약을 이번 전시를
            통해 선보이고자 합니다. <br />
            <br />
            2024 한국기술교육대학교 디자인공학과 졸업 전시에서는 총 23개의 팀이
            <br />
            Mobility, Care, Living 분야에서 각자의 ‘디자인 해석’을 싹 틔웁니다.
            <br />
            <br />
            작은 씨앗을 품고 세상으로 날아오르는 도약의 순간, 우리들의 멋진
            발아를 응원해주세요.
          </div>
        </div>
          ...
          <div>
            ...
            <div className={styles['exhibit-section__detail']}>
              <ul className={styles['exhibit-section__detail-title']}>
                ...
                <li className={styles['exhibit-section__detail-info']}>Care</li>
                <li className={styles['exhibit-section__detail-info']}>
                  Living
                </li>
              </ul>
          ...
          <div className={styles['committee-section__member-section']}>
            {MEMBERS.map((item) => (
              ...
              >
                ...
                <div className={styles['committee-section__member-group-unit']}>
                  {item.member}
                </div>
              </div>
            ))}
